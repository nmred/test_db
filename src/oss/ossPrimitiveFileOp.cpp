...
// }}}
// {{{ ossPrimitiveFileOp::getCurrentOffset() const
...
// }}}
// {{{ ossPrimitiveFileOp::seekToOffset()

void ossPrimitiveFileOp::seekToOffset(const offsetType offset)
{
...
// }}}
// {{{ ossPrimitiveFileOp::setFileHandle()
